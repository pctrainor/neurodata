...
// AI PROCESSING
// =============================================================================
async function processNode(node, connectedResults, workflowContext) {
...
function buildNodePrompt(node, connectedResults, workflowContext) {
...
async function executeWorkflow(job) {
    ...
    const outputNodeIds = new Set(nodes
...
async function refundCredits(job) {
    try {
        // Get current credits
