...
2. Create MULTIPLE brainNode agents, each with unique:
...
For large counts (50+), generate a representative sample (10-20 nodes) and indicate the pattern.
Example for "100 viewers, 20 from each age group":
- Generate 2-4 sample viewers per age group (10-20 total)
- Include a comment in the description noting the full intended count
